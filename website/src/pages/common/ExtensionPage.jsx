    ...
    <MainLayout>
      ...
      <div className="py-8 sm:py-6">
        <div className="container mx-auto px-5 sm:px-4">
          ...
          <p>
            PhishDetect.net là extension giúp bạn phát hiện và tránh các trang web lừa đảo khi duyệt
            web. Với công nghệ AI, PhishDetect.net có thể phân tích các trang web và đưa ra cảnh báo
            nếu phát hiện rủi ro lừa đảo.
          </p>
          <div className="my-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-1 gap-6">
            ...
            <div className="bg-tertiary/15 rounded-lg shadow-lg p-5 text-center animate-appear-from-right">
              ...
              <p className="text-gray-600">
                Hiện tại extension của chúng tôi chỉ hỗ trợ trên trình duyệt Chrome. Chúng tôi sẽ
                liên tục phát triển để hỗ trợ nhiều trình duyệt hơn.
              </p>
            </div>
          </div>
        </div>
